  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8">
      <div className="text-center mb-8">
        <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-emerald-500 to-orange-500 text-white py-3 px-6 rounded-lg font-semibold hover:from-emerald-600 hover:to-orange-600 transition-all duration-200 flex items-center justify-center space-x-2"
        >
