  ...
  if (isComplete) {
    return (
      <div className="text-center p-8">
        <div className="w-24 h-24 bg-gradient-to-r from-emerald-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6">
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-between">
        ...
        <button
          onClick={goToNext}
          disabled={!isAnswered}
          className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-orange-500 text-white rounded-lg hover:from-emerald-600 hover:to-orange-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
